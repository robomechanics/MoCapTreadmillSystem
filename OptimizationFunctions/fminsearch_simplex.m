function [x,fval,exitflag,output] = fminsearch_simplex(funfcn,simplex,options,varargin)
...
%BLW Code
% Set simplex and their evaluations
v = simplex(1:n,:); 
fv = simplex(n+1,:);
func_evals = 1;
itercount = 0;
